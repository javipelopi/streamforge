...
// ============================================================================
// Standalone functions (no Tauri State dependency — usable from CLI)
// ============================================================================

/// Export configuration to a JSON string, without requiring Tauri `State`.
...
/// Import configuration from a JSON string, without requiring Tauri `State`.
